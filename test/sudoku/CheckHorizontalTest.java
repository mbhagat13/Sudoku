...
int[][] solution = {    {8,9,3, 7,4,5, 2,1,6},
    ...
    /**
     * Test of checkMoves method, of class CheckHorizontal. 2 cases. Black box testing.
     */
    @Test
    public void testCheckMoves() {
        System.out.println("checkMoves (horiz)");
        CheckHorizontal instance = new CheckHorizontal();
